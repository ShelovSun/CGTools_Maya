...
def matchInIndex(node, index):
    ...
    :type index: dict[list[utils.Node]]
    :rtype: Node
    """
    result = None
...
def matchNames(srcObjects, dstObjects=None, dstNamespaces=None, search=None, replace=None):
    ...
    :rtype: list[(utils.Node, utils.Node)]
    """
    results = []
