...
// www.monikagelbmann.com
	...
	INSTALLATION:
	a) Copy the file (mog_ikFkSwitch.py) to your Maya for_Maya directory. On Windows that is Documents/maya/20xx/for_Maya/
	...
	1.8 - September 20, 2019 -	Added knee/ellbow Bend Attribute to solve pole vector flip issues
								Added more Info tools_about Rotation Offset and Bend Angle to Help tab 
...
class FkIk_UI:
	...
	def initializeTab(self, tabHeight, tabWidth):
		...
		pm.separator(h=5)
		pm.text('Release 1.11                 Monika Gelbmann                  07/2020')
		pm.separator(h=5)
