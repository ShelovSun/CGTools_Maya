...
def __setAbstractMaterial(thisAbstractMaterial,defaultAttr_specificAttr_dict,userDefinedPath,materialName,materialAttrsData,textureTemplatesData,usingMayaColorManagement,isUdim):
    ...
    selfOperater = textureTemplatesData[textureTemplateUsing]['primaryReflectionRoughness']  #rough or gloss
    targetOperater = materialAttrsData[targetMaterialType]['primaryReflectionRoughness'][1]  #default gloss    reverse rough
