...
//Name: lum.ma
//Last modified: Tue, Feb 23, 2016 03:53:01 PM
//Codeset: 936
requires maya "2014";
...
createNode lambert -n "DEPTHSG";
	setAttr ".dc" 0;
	setAttr ".c" -type "float3" 1 1 1 ;
createNode setRange -n "Z_setRange1";
	setAttr ".n" -type "float3" 1 0 0 ;
	setAttr ".on" -type "float3" 0.1 0 0 ;
	setAttr ".om" -type "float3" 1000 0 0 ;
createNode multiplyDivide -n "Z_multiplyDivide1";
	setAttr ".i2" -type "float3" -1 1 1 ;
createNode samplerInfo -n "Z_samplerInfo1";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "Z_setRange1.ox" "DEPTHSG.acr";
connectAttr "Z_setRange1.ox" "DEPTHSG.acg";
connectAttr "Z_setRange1.ox" "DEPTHSG.acb";
connectAttr "Z_multiplyDivide1.ox" "Z_setRange1.vx";
connectAttr "Z_samplerInfo1.pz" "Z_multiplyDivide1.i1x";
connectAttr "DEPTHSG.msg" ":defaultShaderList1.s" -na;
connectAttr "Z_setRange1.msg" ":defaultTextureList1.tx" -na;
connectAttr "Z_multiplyDivide1.msg" ":defaultTextureList1.tx" -na;
connectAttr "Z_samplerInfo1.msg" ":defaultTextureList1.tx" -na;
// End of lum.ma
