...
//Name: LUM_SG.ma
//Last modified: Tue, Dec 22, 2015 10:25:01 AM
//Codeset: 936
requires maya "2014";
...
createNode mentalrayOptions -s -n "miDefaultOptions";
	...
	setAttr ".stringOptions[30].value" -type "string" "1";
	setAttr ".stringOptions[30].type" -type "string" "scalar";
	setAttr ".stringOptions[31].name" -type "string" "samples min";
	setAttr ".stringOptions[31].value" -type "string" "1.0";
	setAttr ".stringOptions[31].type" -type "string" "scalar";
	setAttr ".stringOptions[32].name" -type "string" "samples max";
	setAttr ".stringOptions[32].value" -type "string" "9";
...
createNode renderLayer -n "DEPTH";
	setAttr -s 3 ".adjs";
...
createNode samplerInfo -n "samplerInfo1";
	addAttr -ci true -sn "cameraNearClipPlane" -ln "cameraNearClipPlane" -at "float";
	addAttr -ci true -sn "cameraFarClipPlane" -ln "cameraFarClipPlane" -at "float";
	setAttr ".cameraNearClipPlane" 0.10000000149011612;
	setAttr ".cameraFarClipPlane" 10000;
createNode multiplyDivide -n "multiplyDivide1";
	setAttr ".i2" -type "float3" -1 1 1 ;
createNode setRange -n "setRange1";
	setAttr ".n" -type "float3" 1 0 0 ;
createNode surfaceShader -n "A_DEPTH_LUM_SG";
...
connectAttr "renderLayerManager.rlmi[1]" "DEPTH.rlid";
connectAttr ":defaultRenderGlobals.ren" "DEPTH.adjs[0].plg";
connectAttr ":defaultRenderGlobals.edl" "DEPTH.adjs[1].plg";
connectAttr ":defaultRenderQuality.eaa" "DEPTH.adjs[2].plg";
connectAttr "set1.msg" "DEPTH.sgo";
...
connectAttr "setRange1.ox" "A_DEPTH_LUM_SG.ocr";
connectAttr "setRange1.ox" "A_DEPTH_LUM_SG.ocg";
connectAttr "setRange1.ox" "A_DEPTH_LUM_SG.ocb";
connectAttr "A_DEPTH_LUM_SG.oc" "set1.ss";
connectAttr "set1.msg" "materialInfo1.sg";
connectAttr "A_DEPTH_LUM_SG.msg" "materialInfo1.m";
connectAttr "A_DEPTH_LUM_SG.msg" "materialInfo1.t" -na;
connectAttr "set1.pa" ":renderPartition.st" -na;
connectAttr "A_DEPTH_LUM_SG.msg" ":defaultShaderList1.s" -na;
