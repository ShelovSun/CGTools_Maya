...
//Name: RIM_UD_SG.ma
//Last modified: Tue, Dec 22, 2015 10:23:29 AM
//Codeset: 936
requires maya "2014";
...
createNode place3dTexture -n "RIM_UD_SG_place3dTexture";
	setAttr ".t" -type "double3" 0 49.450222703905879 -207.70587688180694 ;
	setAttr ".s" -type "double3" 230.3883475722904 54.588169762489287 230.3883475722904 ;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 495.79131134716999 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 495.79131134716999;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 495.79131134716999 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 495.79131134716999 0 0 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode lambert -n "A_RAM_UD_SG";
	setAttr ".dc" 0;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".mpr";
	setAttr -k on ".wzd";
	setAttr -k on ".fn" -type "string" "iconTmp";
	setAttr -k on ".if" 20;
	setAttr -k on ".res" -type "string" "64x64 64 64 1.0";
	setAttr -k on ".as";
	setAttr -k on ".ds";
	setAttr -k on ".lm";
	setAttr -k on ".fir";
	...
	setAttr -cb on ".sd";
lockNode -l 1 ;
connectAttr "projection1.oc" "A_RAM_UD_SG.c";
connectAttr "RIM_UD_SG_place3dTexture.wim" "projection1.pm";
connectAttr "ramp.oc" "projection1.im";
connectAttr "place2dTexture2.o" "ramp.uv";
connectAttr "place2dTexture2.ofs" "ramp.fs";
...
connectAttr "A_RAM_UD_SG.msg" ":defaultShaderList1.s" -na;
connectAttr "projection1.msg" ":defaultTextureList1.tx" -na;
connectAttr "ramp.msg" ":defaultTextureList1.tx" -na;
connectAttr "RIM_UD_SG_place3dTexture.msg" ":defaultRenderUtilityList1.u" -na;
