...
//Name: RIM_B_SG.ma
//Last modified: Thu, Jan 21, 2016 01:40:11 PM
//Codeset: 936
requires maya "2014";
...
createNode lambert -n "A_RIM_B_SG";
	setAttr ".dc" 0;
	setAttr ".ambc" -type "float3" 1 1 1 ;
createNode ramp -n "ShiWanShanGracle_RIM_SG:rim:ramp1";
	setAttr -s 2 ".cel";
	setAttr ".cel[0].ep" 0;
	setAttr ".cel[0].ec" -type "float3" 1 1 1 ;
	setAttr ".cel[2].ep" 0.5;
	setAttr ".cel[2].ec" -type "float3" 0 0 0 ;
createNode place2dTexture -n "ShiWanShanGracle_RIM_SG:rim:place2dTexture1";
createNode samplerInfo -n "ShiWanShanGracle_RIM_SG:rim:samplerInfo1";
...
connectAttr "ShiWanShanGracle_RIM_SG:rim:ramp1.oc" "A_RIM_B_SG.c";
connectAttr "ShiWanShanGracle_RIM_SG:rim:place2dTexture1.o" "ShiWanShanGracle_RIM_SG:rim:ramp1.uv"
		;
connectAttr "ShiWanShanGracle_RIM_SG:rim:samplerInfo1.fr" "ShiWanShanGracle_RIM_SG:rim:ramp1.v"
		;
connectAttr "ShiWanShanGracle_RIM_SG:rim:place2dTexture1.ofs" "ShiWanShanGracle_RIM_SG:rim:ramp1.fs"
		;
...
connectAttr "A_RIM_B_SG.msg" ":defaultShaderList1.s" -na;
connectAttr "ShiWanShanGracle_RIM_SG:rim:ramp1.msg" ":defaultTextureList1.tx" -na
		;
connectAttr "ShiWanShanGracle_RIM_SG:rim:place2dTexture1.msg" ":defaultRenderUtilityList1.u"
		 -na;
connectAttr "ShiWanShanGracle_RIM_SG:rim:samplerInfo1.msg" ":defaultRenderUtilityList1.u"
		 -na;
